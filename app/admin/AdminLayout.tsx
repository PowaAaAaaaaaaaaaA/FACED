...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="drawer lg:drawer-open">
      ...
      {/*Right panel — renders the current page */}
        ...
        <ul className="menu min-h-full w-80 p-4 flex flex-col gap-10 bg-[#0D1B4B] text-white">
          ...
          <div className="gap-2 flex flex-col">
            ...
            <li className="hover:bg-amber-400 rounded-[5px]">
              <Link href="/faced-cards"><PiCards className="text-2xl" /> FACED Cards</Link>
            </li>
            <li className="hover:bg-amber-400 rounded-[5px]">
              <Link href="/beneficiaries"><BsPersonFill className="text-2xl" /> Beneficiaries</Link>
            </li>
          </div>
        </ul>
      </div>
