...
export default function SurveyPage() {
  ...
  const updateMember = (id: number, field: keyof FamilyMember, value: string) => {
    ...
    setErrors((prev) => {
      ...
      delete u.members // also clear the general members error
      return u
    })
  }
  ...
  const handleNext = () => {
    ...
    if (step === 3) {
      // Each row that has any data must be fully filled
      ...
      // Also check at least one member exists
      if (members.length === 0) {
